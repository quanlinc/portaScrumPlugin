// ==UserScript==
// @name        PortaScrumPlugin
// @namespace   Amazon
// @include     https://scrum.amazon.com/sprints/*
// @version     0.1
// ==/UserScript==
...
var plugin = (function($, doc){
    ...
    var postData = function(storyData){
        ...
        $.ajax({
            ...
            success:function(html){//get next sprint page first and populate data for creating new story
                ...
                //create story
                var createStoryURL = protocol + host + "/stories/create";
                var data = {
                    "commit": "Add Story",
                    ...
                    complete: function(){
                        $.ajax({
                            ...
                            success:function(html){
                                ...
                                var taskCreateURL = protocol + host + "/tasks/create";
    ...
    var hasNextSprint = function(){
        ...
        //temporarily we only have one URL need to cache due to expensive cost,
        //so right now will take a shortcut to verify if there is something being cached, later on need some refactor.
        if(cachedURLs.length != 0){
            result.hasNext = true;
            result.nextURL = cachedURLs[0];
        } else{
            $.ajax({
                url: sprintListURL,
                type: "GET",
                ...
                success:function(html){
                    ...
                    cachedURLs.push(result.nextURL);
                },
                error: function(XMLHttpRequest, textStatus, errorThrown){
                    console.log(textStatus);
                    console.log(errorThrown);
